// Custom Cloudflare Pages Worker that wraps OpenNext's generated worker
// This adds static asset serving from the ASSETS binding
...
export default {
  async fetch(request, env, ctx) {
    return runWithCloudflareRequestContext(request, env, ctx, async () => {
      ...
      // *** CRITICAL: Serve static assets directly from ASSETS binding ***
      // This includes CSS, JS, images, fonts, etc. in _next/static/
      // Without this, all static assets return 404 in Cloudflare Pages
      if (
